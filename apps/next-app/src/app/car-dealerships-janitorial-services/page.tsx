      ...
      <section className={`${styles.section} ${styles.locationSection}`}>
        <div className="container">
          <div className={styles.sectionHeader}>
            ...
            <div className={styles.sectionTitleDivider}></div>
            <p className={styles.sectionSubtitle}>
              We proudly provide showroom floor care and janitorial maintenance across the San Fernando Valley and Greater Los Angeles.
            </p>
          </div>
          ...
          <div className={styles.footerGrid}>
            ...
            <div className={styles.footerCol}>
              ...
              <div className={styles.footerLinks}>
                ...
                <a href="/#services" className={styles.footerLink}>Medical Clinics Cleaning</a>
